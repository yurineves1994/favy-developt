                ...
                <form action="<c:url value="/EditarCliente"/>" method="POST" >
                    ...
                    <fieldset class="row" id="endereco-faturamento">
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            <input value="${cliente.cepFat}" required name="cep" type="number" class="form-control" id="cep" placeholder="">
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="logradouro"> RUA </label>
                            <input value="${cliente.ruaFat}" required name="logradouro" type="text" class="form-control" id="logradouro" placeholder="">
                        </div>
                        <div class="form-group col-sm-2">
                            <label for="bairro"> BAIRRO </label>
                            <input value="${cliente.bairroFat}" required name="bairro" type="text" class="form-control" id="bairro" placeholder="">
                        </div>
                        <div class="form-group col-sm-2">
                            <label for="localidade"> CIDADE </label>
                            <input value="${cliente.cidadeFat}" required name="localidade" type="text" class="form-control" id="localidade" placeholder="">
                        </div>
                        <div class="form-group col-sm-2">
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            <input value="${cliente.numFat}" required name="numero" type="number" class="form-control" id="numero" placeholder="">
                        </div>                  
                        <div class="form-group col-sm-4">
                            <label for="complemento"> COMPLEMENTO </label>
                            <input value="${cliente.complFat}" required name="complemento" type="text" class="form-control" id="complemento" placeholder="">
                        </div>                      
                    </fieldset>
                    <div class="form-group">
                    ...
                    <fieldset class="endereco-entrega01">
                        ...
                        <div class="row" class="grupoEnderecoEntrega1">
                            <div class="form-group col-sm-2">
                                ...
                                <input value="${cliente.cepEnt1}"  name="cepEntrega1" type="number" class="form-control" id="cepEntrega1" placeholder="">
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="logradouroEntrega1"> RUA </label>
                                <input value="${cliente.ruaEnt1}" name="logradouroEntrega1" type="text" class="form-control" id="logradouroEntrega1" placeholder="">
                            </div>
                            <div class="form-group col-sm-2">
                                <label for="bairroEntrega1"> BAIRRO </label>
                                <input value="${cliente.bairroEnt1}" name="bairroEntrega1" type="text" class="form-control" id="bairroEntrega1" placeholder="">
                            </div>
                            <div class="form-group col-sm-2">
                                <label for="localidadeEntrega1"> CIDADE </label>
                                <input value="${cliente.cidadeEnt1}" name="localidadeEntrega1" type="text" class="form-control" id="localidadeEntrega1" placeholder="">
                            </div>
                            <div class="form-group col-sm-2">
                                <label for="ufEntrega1"> ESTADO </label>                    
                                <select value="${cliente.ufEnt1}" id="ufEntrega1" name="ufEntrega1" class="form-control">
                                    <option value=></option>
                                    <option value="AC">AC</option>
                                    <option value="AL">AL</option>
                                    <option value="AP">AP</option>
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <input value="${cliente.numEnt1}" name="numeroEntrega1" type="number" class="form-control" id="numeroEntrega1" placeholder="">
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="complementoEntrega1"> COMPLEMENTO ENTREGA 1</label>
                                <input value="${cliente.complEnt1}" name="complementoEntrega1" type="text" class="form-control" id="complementoEntrega1" placeholder="">
                            </div>                      
                        </div>
                    </fieldset>
